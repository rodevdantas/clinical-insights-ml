...
|-------------------------|------------------|------------------------------------------------------------------------|-------------|
| **K-Means**             | Não-Supervisionado | Clusteriza pacientes em perfis RFM (ex.: "VIPS", "OBS. LEVE")          | Estável após log transform |
...
| Plotly     | Gráficos interativos: scatterplot, barras e lista/tabela |
